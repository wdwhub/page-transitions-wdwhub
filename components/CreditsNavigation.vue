<template>
  ...
  >
    <transition-group name="bk" tag="div" class="bk-img">
      ...
      <div key="img2" v-else-if="page === 'credits'" class="header-img2"></div>
...
import CreditsNavTransition from "./CreditsNavTransition.vue";
